...
public class goldenclient extends client {
    ...
    public goldenclient(int day,int month,int year, String FavouriteProduct, String street, String town, String homenumber, String ID, String Name, int PhoneNumber, int age) {
